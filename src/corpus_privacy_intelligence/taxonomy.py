...
SENSITIVE_DOMAIN_TERMS: dict[str, list[str]] = {
    # Unambiguous clinical vocabulary stays as single tokens. Terms that are also ordinary
    # engineering or general English ("health check", "home lab", "sleep mode", "weight
    # matrix", "pain point") are matched as phrases instead, so they only signal private
    # health in an actual health context. See tests/test_privacy_fixtures.py.
    "private_health": [
        "medical",
        "doctor",
        "diagnosis",
        ...
        "minoxidil",
        "finasteride",
        # phrase forms of terms that are otherwise ordinary words
        "my health",
        "health condition",
        "health issue",
        "mental health",
